                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6">
                            {filteredProducts.map((product, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="bg-white rounded-2xl shadow-lg shadow-pink-200/20 hover:shadow-2xl hover:shadow-blue-200/30 border-2 border-transparent hover:border-blue-200 transition-all duration-500 hover:scale-105 overflow-hidden">
                                            ...
                                            <div className="relative aspect-square bg-gradient-to-br from-pink-50 to-blue-50">
                                                ...
                                                {productImages.length > 1 && hoveredProduct === product._id && (
                                                    <>
                                                        <button
                                                            ...
                                                            className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/90 backdrop-blur-sm rounded-full p-2 opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white hover:scale-110 shadow-lg shadow-blue-200/30 z-20"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/90 backdrop-blur-sm rounded-full p-2 opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white hover:scale-110 shadow-lg shadow-blue-200/30 z-20"
                                                        >
                                                            <svg className="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <Link href={`/products/${product._id}`}>
                                                    <button className="absolute top-3 right-3 p-2 bg-white/90 backdrop-blur-sm rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white hover:scale-110 shadow-lg shadow-blue-200/30 z-10">
                                                        <svg className="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
