    ...
    return (
        <footer className="relative bg-gradient-to-br from-gray-50 to-white border-t border-gray-200">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 transform transition-all duration-1000 ${
                    ...
                    <div className="space-y-6">
                        ...
                        <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-9 h-9 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:border-red-500 hover:text-red-600 hover:bg-red-50 transition-all duration-300"
                                aria-label="Website"
                            >
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link 
                                    href="/about"
                                    className="text-gray-600 hover:text-red-600 text-sm transition-colors duration-300 inline-flex items-center group"
                                >
